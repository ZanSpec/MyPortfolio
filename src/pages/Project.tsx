...
const projects = [
  ...
  },
  {
    ...
    fullDescription:
      "READ E-COM: Learning Quest is a classroom-based educational game platform designed to make quiz-style learning interactive and structured. Teachers configure a series of compartments, each containing a custom puzzle or quiz challenge, before opening the session to students. Once the game begins, students join and progress through the compartments in sequence, scanning a QR code at each stage to unlock the next puzzle and advance toward completion. Built with React, Vite, and Supabase, the platform combines real-time session management with an intuitive teacher-facing setup interface and a streamlined, mobile-friendly student experience — turning traditional classroom quizzes into a structured, self-paced learning challenge.",
    role: "Fullstack Developer",
    year: "2026",
    tools: ["React", "Vite", "Supabase"],
    carousel: [
      "/images/learningquest/carousel/learningquest-1.png",
      "/images/learningquest/carousel/learningquest-2.png",
      "/images/learningquest/carousel/learningquest-3.png",
      "/images/learningquest/carousel/learningquest-4.png",
    ],
    gallery: [
      "/images/learningquest/gallery/learningquest-1.png",
      "/images/learningquest/gallery/learningquest-2.png",
      "/images/learningquest/gallery/learningquest-3.png",
      "/images/learningquest/gallery/learningquest-4.png",
      "/images/learningquest/gallery/learningquest-5.png",
      "/images/learningquest/gallery/learningquest-6.png",
      "/images/learningquest/gallery/learningquest-7.png",
      "/images/learningquest/gallery/learningquest-8.png",
      "/images/learningquest/gallery/learningquest-9.png",
      "/images/learningquest/gallery/learningquest-10.png",
      "/images/learningquest/gallery/learningquest-11.png",
      "/images/learningquest/gallery/learningquest-12.png",
      "/images/learningquest/gallery/learningquest-13.png",
      "/images/learningquest/gallery/learningquest-14.png",
      "/images/learningquest/gallery/learningquest-15.png",
      "/images/learningquest/gallery/learningquest-16.png",
    ],
  },
  {
    id: 4,
